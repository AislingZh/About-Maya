...
class FacialConnectWin(object):
    # Vertical 竖直方向 y轴
    #+
    blName1 = ['Brows_R_Up', 'Brows_L_Up', 'Brows_C_Up', 'Sneer_Up_Right']
    blName2 = ['Eyes_R_Wide', 'Eyes_L_Wide', 'Eyes_Look_Up', 'Mouth_Up', 'Lips_L_Smile', 'Lips_R_Smile']

    blNameB1 = ['Brows_R_UpB', 'Brows_L_UpB', 'Brows_C_UpB']
    #-
    blName3 = ['Brows_R_Down', 'Brows_L_Down', 'Brows_C_Down']

    blNameB2 = ['Brows_R_DownB', 'Brows_L_DownB', 'Brows_C_DownB']

    blName4 = ['Eyes_R_Blink', 'Eyes_L_Blink', 'Eyes_Look_Down', 'Jaw_Open', 'Mouth_Down', 'Lips_L_Frown', 'Lips_R_Frown']
    #Horizontal 水平方向 x轴
    #+
    blName5 = ['Eyes_Narrow', 'Eyes_Look_Left', 'Sneer_Up_Left']
    blName6 = ['Brows_R_Squeeze', 'Brows_L_Squeeze', 'Nostril_Flare']

    blNameB3 = ['Brows_R_SqueezeB', 'Brows_L_SqueezeB']

    blName7 = ['O_Phoneme', 'Ch_Phoneme', 'MBP_Phoneme', 'Fv_Phoneme', 'Du_Phoneme']  
    ...
    #Corners 四个角 xy轴混合用
    #+-
    blName11 = ['Cheek_LSquint', 'UpperLips_LDown', 'LowerLips_LUp']
    #-+
    blName12 = ['Cheek_LPuff', 'UpperLips_LUp', 'LowerLips_LDown']
    #++
    blName13 = ['Cheek_RPuff', 'UpperLips_RUp', 'LowerLips_RDown']
    #--
    blName14 = ['Cheek_RSquint', 'UpperLips_RDown', 'LowerLips_RUp']
    ...
    def DoBrowesConnect(self):
        blNameList = self.blNameB3 + self.blNameB1 + self.blNameB2
